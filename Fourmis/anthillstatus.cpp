...
void AnthillStatus::display(int nb_ant, int nb_egg, int nb_larva, int nb_worker, int nb_warrior, int nb_queen, int nb_max_ant, int amount_food, int max_amount_food)
{
