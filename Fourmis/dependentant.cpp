...
DependentAnt::DependentAnt(Environnement& _env, Anthill* _anthill, bool _is_queen, int _max_food_need, int _time_to_transition, float _food_need, bool _is_being_fed, std::unique_ptr<State> _state) :
